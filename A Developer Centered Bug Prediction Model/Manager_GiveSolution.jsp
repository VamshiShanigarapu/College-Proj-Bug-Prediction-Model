...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Give Solution to Team Member Defect..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
		  ...
		  %>
            ...
            <form name="s" action="Manager_GiveSolution1.jsp?prjname=<%=prjname%>&developer=<%=developer%>&id=<%=id%>" method="post"  onSubmit="return valid()"  ons target="_top">
	...
	<table width="600" border="0" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; display:inline; margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
			...
			<p>&nbsp;</p>
		<div align="right" class="style22"><a href="Manager_ViewTmMbrDefects1.jsp?prjname=<%=prjname%>" class="style11">Back</a></div>
