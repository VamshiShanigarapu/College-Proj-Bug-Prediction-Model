...
<title> Manager Solution Details..</title>
...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Team Manager Solution Details..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
					<table width="471" height="74" border="1" align="center"  cellpadding="0" cellspacing="0"  >
               <tr bgcolor="#FFFFFF">
			    <td  width="132" height="29" valign="baseline" bgcolor="#FFFFFF" style="color: #660033;"><div align="center" class="style4 style6" ><b>Team Manager</b></div></td>
					  ...
					  int i=1,j=0,count=0,r=0;
						...
						try 
						{
							...
							int id = Integer.parseInt(one);
						   	...
						   	String query="select * from manager_soln where (company='"+company+"' and prjname='"+prjname+"') and reqid="+id+" "; 
            ...
            <%
					...
					if(count==0){out.print("Solution Not Given by the Team Manager");}
					
					%>
        </table>
		
			<p>&nbsp;</p>
		<div align="right" class="style22"><a href="Admin_ViewTeamMngrSoln.jsp?prjname=<%=prjname%>" class="style11">Back</a></div>	
