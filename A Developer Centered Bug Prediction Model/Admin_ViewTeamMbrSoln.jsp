...
<title>Team Member Solution..</title>
...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Solutions Based on Team Member..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
				<p>&nbsp;</p>
				<p>&nbsp;</p>
               ...
               <tr bgcolor="#FFFFFF">
				 ...
				 <td  width="116" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #660033;"><div align="center" class="style4 style6" ><b>Requested Developer </b></div></td>
				 <td  width="116" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #660033;"><div align="center" class="style4 style6" ><b>Requested To Team Member </b></div></td>
            ...
            <%
					  ...
					  int i=1,j=0,count=0,r=0;
						...
						try 
						{
						   	...
						   	String query="select * from defects_tmember where prjname='"+prjname+"' and company='"+company+"' "; 
            ...
            <tr>
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style8" >
                    <div align="center">
               <a href="Admin_DeveloperProfile.jsp?type=<%="Admin_ViewTeamMemberSolution"%>&prjname=<%=prjname%>&uname=<%=s5%>" style="color:#CC0033">     <b><%out.println(s5);%></b>  </a>               </div>
              </div></td>
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style8" >
                    <div align="center">
                   <a href="Admin_DeveloperProfile.jsp?type=<%="Admin_ViewTeamMemberSolution"%>&prjname=<%=prjname%>&uname=<%=s0%>" style="color:#990066"> <b><%out.println(s0);%></b>   </a>             </div>
              </div></td>
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style5" >
           	        <a href="Admin_ViewMbrSolution.jsp?prjname=<%=s1%>&id=<%=j%>" style="color:#FF3300"><b>View Solution</b></a> </div></td>	
			  </tr>
            <%
					i=i+1;	
			...
			<p>&nbsp;</p>
		    <div align="right" class="style22"><a href="Admin_ViewBugDetails.jsp" class="style11">Back</a></div>
