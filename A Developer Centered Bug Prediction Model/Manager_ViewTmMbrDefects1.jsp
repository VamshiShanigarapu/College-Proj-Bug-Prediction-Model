...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">All Team Member Defects..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
					<p>&nbsp;</p>
				<p>&nbsp;</p>
               ...
               <tr bgcolor="#FFFFFF">
				 ...
				 <td  width="136" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #660033;"><div align="center" class="style4 style6" ><b> </b></div></td>
				 </tr>
            ...
            <%
					  ...
					  int i=1,j=0,count=0,r=0;
						...
						try 
						{
						   	...
						   	String query="select * from defects_tmanager where prjname='"+prjname+"' and (company='"+company+"' and manager='"+manager+"') "; 
            ...
            <tr>
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style9" >
                    <div align="center">
                  <a href="Manager_DeveloperProfile.jsp?type=<%="Manager_ViewTeamMemberDefects"%>&prjname=<%=prjname%>&uname=<%=s0%>" style="color:#CC0033">  <b><%out.println(s0);%></b>        </a>        </div>
              </div></td>
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style5" >
           	        <a href="Manager_GiveSolution.jsp?prjname=<%=s1%>&developer=<%=s0%>&id=<%=j%>"><b>Give Solution</b></a> </div></td>	
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style5" >
           	        <a href="Manager_AlctToOtrTeamMembers.jsp?prjname=<%=s1%>&developer=<%=s0%>&dfct=<%=s2%>&company=<%=company%>&manager=<%=manager%>" class="style1">Allocate to Other Team Members</a> </div></td>	
			 </tr>
            <%
					i=i+1;	
			...
			<p>&nbsp;</p>
		    <div align="right" class="style22"><a href="Manager_ViewTmMbrDefects.jsp" class="style11">Back</a></div>
