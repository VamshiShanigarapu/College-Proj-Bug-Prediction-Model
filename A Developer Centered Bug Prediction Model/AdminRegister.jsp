...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Welcome To Admin Registration..</a></h2>
				<div class="entry">
				<p><img src="images/Register.jpg" alt="" width="293" height="155" /></p>
					<form name="s" action="AdminRegisterStatus.jsp" enctype="multipart/form-data" method="post" onsubmit="return valid()"  >
					<span class="style1">
