		...
		<div id="content">
			<div class="post">
				...
				<p>&nbsp;</p>
					...
					String cname=(String)application.getAttribute("dcname");
            ...
            <%
					...
					%>
		  			...
		  			<h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("Developer_ViewTeamMemberSolution")){%>
            <h3 align="right"><a href="Developer_ViewTeamMbrSoln.jsp?prjname=<%=prjname%>" class="style3 style5">Back</a></h3>
			<%}
			else if(type.equalsIgnoreCase("Developer_ViewTeamMemberDefects")){%>
            <h3 align="right"><a href="Developer_ViewTmMbrDefects1.jsp?prjname=<%=prjname%>" class="style5 style3">Back</a></h3>
			<%}	
