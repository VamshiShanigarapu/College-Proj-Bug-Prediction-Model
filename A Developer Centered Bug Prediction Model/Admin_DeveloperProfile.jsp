		...
		<div id="content">
            ...
            <%
					...
					%>
		  			...
		  			<h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("Admin_AuthorizeDevelopers")){%>
            <h3 align="right"><a href="Admin_AuthorizeDevelopers.jsp" class="style3 style5">Back</a></h3>
			<%}
			else if(type.equalsIgnoreCase("Admin_ViewTeamMembers")){%>
            <h3 align="right"><a href="Admin_ViewTmMbrs.jsp?prjname=<%=prjname%>&manager=<%=manager%>" class="style5 style3">Back</a></h3>
			<%}	
			else if(type.equalsIgnoreCase("Admin_ViewTeamMemberSolution")){%>
            <h3 align="right"><a href="Admin_ViewTeamMbrSoln.jsp?prjname=<%=prjname%>" class="style5 style3">Back</a></h3>
			<%}	
