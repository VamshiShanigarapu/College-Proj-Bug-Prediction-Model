...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Welcome To Developer Registration..</a></h2>
				<div class="entry">
				<p><img src="images/Register.jpg" alt="" width="306" height="148" /></p>
					<form name="s" action="DeveloperRegisterStatus.jsp" enctype="multipart/form-data" method="post" onsubmit="return valid()"  >
					<span class="style1">
			       ...
			       <br />
                    ...
                    <p>&nbsp;</p>
			        <p align="left" class="style14"><a href="DeveloperLogin.jsp" class="style11">Back</a></p>
		          </form>
