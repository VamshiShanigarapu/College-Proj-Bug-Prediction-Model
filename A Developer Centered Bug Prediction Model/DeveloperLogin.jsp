...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Welcome To Developers Login..</a></h2>
				<div class="entry">
				<p><img src="images/Alogin.png" alt="" width="220" height="151" /></p>
					<form name="s" method="post" action="DeveloperAuthentication.jsp" onsubmit="return valid()" >
				    <table width="464" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        ...
                        <td><span class="style16">
                          ...
                          <span class="style4"><b> New User?</b></span></span><a href="DeveloperRegister.jsp" class="style2 style30"><b> Register </b></a></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
