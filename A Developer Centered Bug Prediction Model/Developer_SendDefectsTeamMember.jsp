...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Set Defects by selecting Project..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
					<form action="Developer_SendDefectsTeamMember1.jsp" method="post" name="s" onsubmit="return valid()">
      	...
      	try 
	{
           ...
           String query="select prjname,manager from developer_project where company='"+company+"' and developer='"+developer+"' "; 
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div align="left">
                           ...
                           <input type="submit" name="Submit" value="Next" style="background-color:#006633; color:#FFFFFF; width:60px; height:26px;" />
                          </div></td>
                      </tr>
                  </table>
		            <p>
