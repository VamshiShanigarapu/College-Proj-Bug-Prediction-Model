 ...
 * Generated at: 2023-08-18 06:39:51 UTC
...
public final class Developer_005fGiveSolution1_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<h2 class=\"title\"><a href=\"#\">Given Solution Status..</a></h2>\r\n");
	...
	PreparedStatement pst=connection.prepareStatement("insert into developer_soln(company,manager,solby,developer,prjname,solutions,solndt,reqid) values(?,?,?,?,?,?,?,?)");
      ...
      out.write(" \r\n");
      out.write("\t\t\t                      <span class=\"style4 style2 style3\"> Solution Given Successfully...</span>\t\t\t\t  </p>\r\n");
      out.write("\t\t\t\t\t<p><a href=\"Developer_ViewTmMbrDefects1.jsp?prjname=");
      out.print(prjname);
