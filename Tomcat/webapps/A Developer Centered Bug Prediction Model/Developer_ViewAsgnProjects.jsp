...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">All Assigned Projects..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
					
					<table width="431" height="74" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    <tr>
                      <td  width="31"  valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>ID</b></div></td>
					  <td  width="145" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>Project Manager</b></div></td>
                      <td  width="111" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>Project Name</b></div></td>
					  <td  width="134" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b></b></div></td>
                      </tr>
                    ...
                    <tr>
                      <td height="0" align="center"  valign="middle"><div align="center" class="style5"><span class="style1">
					   ...
					   <td height="0" align="center"  valign="middle"><div align="center" class="style6">
                            <span class="style6">
                   <a href="Developer_ManagerProfile.jsp?type=<%="Developer_ViewAssignedProjects"%>&uname=<%=s2%>" style="color:#FF3300">    <b> <%out.println(s2);%> </b>  </a>     </span></div></td>
                      <td height="0" align="center"  valign="middle"><div align="center" class="style7">
                            <span class="style7">
                       <b> <%out.println(s1);%> </b> 	   </span></div></td>
					  <td height="0" align="center"  valign="middle"><a href="Developer_ViewProjects.jsp?prjname=<%=s1%>"><input name="adprj" type="button" value="View Project Details" /></a>					</td>
                    </tr>
                    <%
						}
