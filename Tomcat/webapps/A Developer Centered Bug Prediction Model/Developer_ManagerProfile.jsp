		...
		<div id="content">
            ...
            <%
					...
					%>
		  			...
		  			<h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("Developer_ViewAssignedProjects")){%>
            <h3 align="right"><a href="Developer_ViewAsgnProjects.jsp" class="style3 style5">Back</a></h3>
			<%}
			else if(type.equalsIgnoreCase("Developer_ViewTeamManagerSolution")){%>
            <h3 align="right"><a href="Developer_ViewTeamMngrSoln.jsp?prjname=<%=prjname%>" class="style5 style3">Back</a></h3>
			<%}	
