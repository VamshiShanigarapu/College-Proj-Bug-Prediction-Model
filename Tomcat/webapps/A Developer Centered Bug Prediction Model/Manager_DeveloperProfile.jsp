		...
		<div id="content">
			<div class="post">
				...
				<p>&nbsp;</p>
					...
					String user=request.getParameter("uname");
						...
						try 
						{
						   	String query="select * from developer where cname='"+cname+"' and username='"+user+"'"; 
					...
					%>
			<p align="center" > <input  name="image" type="image" src="developer_Pic.jsp?id=<%=i%>" style="width:170px; height:170px;" /> </p>		
            ...
            <%
					...
					%>
		  			...
		  			<h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("Manager_ViewEmployees")){%>
            <h3 align="right"><a href="Manager_ViewEmployees.jsp" class="style3 style5">Back</a></h3>
			<%}
			else if(type.equalsIgnoreCase("Manager_ViewTeamMembers")){%>
            <h3 align="right"><a href="Manager_ViewTmMbrs.jsp?prjname=<%=prjname%>" class="style5 style3">Back</a></h3>
			<%}	
			else if(type.equalsIgnoreCase("Manager_ViewProjects")){%>
            <h3 align="right"><a href="Manager_ViewProjects.jsp" class="style5 style3">Back</a></h3>
			<%}	
			else if(type.equalsIgnoreCase("Manager_ViewTeamMemberDefects")){%>
            <h3 align="right"><a href="Manager_ViewTmMbrDefects1.jsp?prjname=<%=prjname%>" class="style5 style3">Back</a></h3>
			<%}	
			else if(type.equalsIgnoreCase("Manager_ViewProjectStatus")){%>
            <h3 align="right"><a href="Manager_ViewPrjStatus1.jsp?prjname=<%=prjname%>" class="style5 style3">Back</a></h3>
			<%}	
			else if(type.equalsIgnoreCase("Manager_ViewProjectComplexity")){%>
            <h3 align="right"><a href="Manager_ViewPrjComplexity1.jsp?prjname=<%=prjname%>" class="style5 style3">Back</a></h3>
			<%}
