...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">All Added Project Details..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
				<p>&nbsp;</p>
				<p>&nbsp;</p>
               ...
               <tr bgcolor="#FFFFFF">
				 ...
				 <td  width="91" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #660033;"><div align="center" class="style4 style6" ><b>Assigned To</b></div></td>
				 ...
				 <td  width="104" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #660033;"><div align="center" class="style4 style6" ><b> </b></div></td>
            ...
            <%
					  ...
					  int i=1,j=0,count=0,r=0;
						...
						try 
						{
						   	...
						   	String query="select * from developer_project where company='"+company+"' and manager='"+manager+"' "; 
            ...
            <tr>
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style9" >
                    <div align="center">
             <a href="Manager_DeveloperProfile.jsp?type=<%="Manager_ViewProjects"%>&uname=<%=s0%>" style="color:#CC0033">       <b><%out.println(s0);%></b>                </div>
              </div></td>
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
				...
				<td  width="105" align="center" valign="middle" height="23"><a href="Manager_EditProject.jsp?id=<%=j%>&prjname=<%=s1%>&company=<%=company%>&manager=<%=manager%>"><input name="edit" type="button" value="Edit" style="background-color:#006633; color:#FFFFFF " /></a> </td>
			...
			<p>&nbsp;</p>
		<div align="right" class="style22"><a href="ManagerMain.jsp" class="style11">Back</a></div>
