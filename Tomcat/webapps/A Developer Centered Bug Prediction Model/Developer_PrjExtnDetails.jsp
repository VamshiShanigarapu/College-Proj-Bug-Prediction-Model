...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Select Project and View Project Extension Details..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
					
					<table width="410" height="74" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    <tr>
                      <td  width="48"  valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>ID</b></div></td>
					  <td  width="181" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>Project Name</b></div></td>
					  <td  width="194" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b></b></div></td>
                      </tr>
                    ...
                    <tr>
					  ...
					  <td height="0" align="center"  valign="middle"><a href="Developer_PrjExtnDetails1.jsp?prjname=<%=s1%>"><input name="adprj" type="button" value="View Extension Details" /></a>					</td>
                    </tr>
                    <%
						}
