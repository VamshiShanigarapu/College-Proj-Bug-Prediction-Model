	...
	<div id="page">
		<div id="content">
			<div class="post">
				...
				<div class="entry">
				<p><img src="images/Alogin.png" alt="" width="226" height="117" /></p>
					<form name="s" method="post" action="AdminAuthentication.jsp" onsubmit="return valid()" >
				    <table width="464" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        ...
                        <td><span class="style16">
                          ...
                          <span class="style4"><b> New User?</b></span></span><a href="AdminRegister.jsp" class="style2 style30"><b> Register </b></a></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
