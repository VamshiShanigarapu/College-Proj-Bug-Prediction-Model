...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Given Solution Status..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
	...
	PreparedStatement pst=connection.prepareStatement("insert into developer_soln(company,manager,solby,developer,prjname,solutions,solndt,reqid) values(?,?,?,?,?,?,?,?)");
             
			pst.setString(1,company);
            pst.setString(2,manager);
            pst.setString(3,developer);
			pst.setString(4,tmember);
			pst.setString(5,prjname);
            pst.setString(6,solution);
			...
			pst.executeUpdate();
                  ...
                  %> 
			                      <span class="style4 style2 style3"> Solution Given Successfully...</span>				  </p>
					<p><a href="Developer_ViewTmMbrDefects1.jsp?prjname=<%=prjname%>" class="style47">Back</a></p>
					<%
