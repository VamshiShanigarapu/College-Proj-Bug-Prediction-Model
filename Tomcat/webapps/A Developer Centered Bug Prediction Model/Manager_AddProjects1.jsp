...
<title>Add Projects Status</title>
	...
	<div id="page">
		<div id="content">
			...
			try {
			 			...
			 			String query1="select * from project  where prjname='"+pname+"' and company='"+company+"' "; 
		          ...
		          <p class="style1" style="color:#660000">Project Name Already Exist..</p>
		          <p align="left"><a href="Manager_AddProjects.jsp" class="style5 style16 style35">Back</a></p>
            <p>&nbsp;            </p>
		          <p>
		            <%
...
PreparedStatement ps=connection.prepareStatement("insert into project(company,manager,prjname,stdate,endate,exptdate) values(?,?,?,?,?,?)");
		          ...
		          <p class="style23">&nbsp;</p>
		          <p class="style1" style="color:#660000">Project Added Successfully.</p>
		          <p class="style19">&nbsp;</p>
