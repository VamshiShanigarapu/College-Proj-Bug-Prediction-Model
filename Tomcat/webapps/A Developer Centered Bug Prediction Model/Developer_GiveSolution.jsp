...
var na1=document.s.sol.value;
if(na1=="")
{

alert("Enter Solution before Submission");
document.s.sol.focus();
return false;
}
...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Give Defects Solution..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
		  ...
		  %>
            ...
            <form name="s" action="Developer_GiveSolution1.jsp?prjname=<%=prjname%>&manager=<%=manager%>&tmember=<%=tmember%>&id=<%=id%>" method="post"  onSubmit="return valid()"  ons target="_top">
	...
	<table width="600" border="0" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; display:inline; margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr><td></td><td></td>
 						<td   width="200" align="left" valign="middle" height="45" style="color: #2c83b0;"><div align="right" class="style9 style4 style2"  style="margin-left:20px;">Write Solution </div></td>

						<td  width="100" align="left" valign="middle" height="45" style="color: #2c83b0;"><div align="left"><div align="left" style="margin-left:20px;"><textarea name="sol" rows="3" cols="23"></textarea></div></td>
			...
			<p>&nbsp;</p>
		<div align="right" class="style22"><a href="Developer_ViewTmMbrDefects1.jsp?prjname=<%=prjname%>" class="style11">Back</a></div>
