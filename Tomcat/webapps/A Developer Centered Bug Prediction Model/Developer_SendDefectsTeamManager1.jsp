...
<title>Send Defects to Team Manager</title>
...
var na4=document.s.tmngr.value;
if(na4=="--Select--")

{
alert("Please Select Team Manager");
document.s.tmngr.focus();
return false;
}
...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Send Defects by selecting corresponding Team Manager..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
					<form action="Developer_SendDefectsTeamManager2.jsp" method="post" name="s" onsubmit="return valid()">
...
%>
					...
					<tr>
                      ...
                      <tr>
                        <td width="175" height="33"><div align="justify"><span class="style3">Select Team Manager :</span></div></td>
                        <td width="390"><label>
                          <select id="s1" name="tmngr" style="width:150px">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div align="left">
                            <input type="submit" name="Submit" value="Send" style="background-color:#CC9900; color:#FFFFFF; width:60px; height:26px;" />
                          </div></td>
                      </tr>
                  </table>
		            <p>
...
%>
			      ...
			      <p>&nbsp;</p>
					...
					<div align="right">
					  ...
					  <p align="center">&nbsp;</p>
					  <p align="center"><a href="Developer_SendDefectsTeamManager.jsp" class="style11">Back</a></p>
					</div>
