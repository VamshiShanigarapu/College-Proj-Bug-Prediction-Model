...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">All Projects..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
					
					<table width="404" height="74" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    <tr>
                      <td  width="42"  valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>ID</b></div></td>
					  <td  width="195" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>Project Name</b></div></td>
					  <td  width="159" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b></b></div></td>
                      </tr>
                    ...
                    <tr>
					  ...
					  <td height="0" align="center"  valign="middle"><a href="Developer_PrjStatusChange1.jsp?prjname=<%=s1%>&manager=<%=s2%>"><input name="prjstat" type="button" value="Change Project Status" /></a>					</td>
                    </tr>
                    <%
						}
