...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#"> Developer <%=(String)application.getAttribute("dname")%>'s Profile..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
            ...
            <%
					...
					%>
		  			...
		  			<p>&nbsp;</p>
				  <p align="right" class="style14"><a href="DeveloperMain.jsp" class="style13">Back</a></p>
