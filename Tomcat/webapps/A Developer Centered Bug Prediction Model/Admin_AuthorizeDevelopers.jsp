...
<title>Authorize Developers</title>
...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Authorize Developers..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
                    ...
                    <tr>
                      ...
                      <td  width="116" valign="middle" height="34" style="color: #660000;"><div align="center" class="style5 style56 style57"><b>Developer Image</b></div></td>
                      <td  width="109" valign="middle" height="34" style="color: #660000;"><div align="center" class="style57 style56 style5"><b>Developer Name</b></div></td>
          ...
          <td height="0" align="center"  valign="middle"><div align="center" class="style5 style20 style37 style54 style55 style22">
                            <span class="style9">
                          <a href="Admin_DeveloperProfile.jsp?type=<%="Admin_AuthorizeDevelopers"%>&uname=<%=s1%>" style="color:#CC0033"> <b> <%out.println(s1);%> </b> </a>
	                 </span></div></td>
                      ...
                      <td valign="middle" height="0" style="color:#000000;"align="center"><div align="center" class="style22 style5 style20 style30 style37">
                          <div align="center" class="style20 style37 style46"><a href="Admin_DeveloperStatus.jsp?id=<%=i%>" class="style2"><b>waiting</b></a></div>
                      </div></td>
                      <%
						}
						else
