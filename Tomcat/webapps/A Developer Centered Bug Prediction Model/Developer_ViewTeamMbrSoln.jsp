...
<title>Solutions by Team Member</title>
		...
		<div id="content">
			<div class="post">
               ...
               <tr bgcolor="#FFFFFF">
				 ...
				 <td  width="116" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #660033;"><div align="center" class="style4 style6" ><b>Team Member </b></div></td>
            ...
            <%
					  ...
					  int i=1,j=0,count=0,r=0;
						...
						try 
						{
						   	...
						   	String query="select * from defects_tmember where prjname='"+prjname+"' and (developer='"+developer+"' and company='"+company+"') "; 
            ...
            <tr>
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style8" >
                    <div align="center">
                <a href="Developer_DeveloperProfile.jsp?type=<%="Developer_ViewTeamMemberSolution"%>&prjname=<%=prjname%>&uname=<%=s0%>" style="color:#CC0033">    <b><%out.println(s0);%></b>                </div>
              </div></td>
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style5" >
           	        <a href="Developer_ViewMbrSolution.jsp?prjname=<%=s1%>&id=<%=j%>" style="color:#FF3300"><b>View Solution</b></a> </div></td>	
			  </tr>
            <%
					i=i+1;	
