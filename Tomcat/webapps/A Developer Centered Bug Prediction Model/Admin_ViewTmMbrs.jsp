...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
				...
				<p>&nbsp;</p>
                    ...
                    <tr>
                      ...
                      <td height="34" align="center"  valign="middle"><div align="center" class="style7">
                            <span class="style7">
                      <a href="Admin_DeveloperProfile.jsp?type=<%="Admin_ViewTeamMembers"%>&prjname=<%=prjname%>&manager=<%=manager%>&uname=<%=s1%>" style="color:#CC0033"> <b> <%out.println(s1);%> </b> 	          </a>       </span></div></td>
					  </tr>
                    <%
						}
            ...
            <tr>
              <td width="468"><div align="right"><a href="Admin_ViewTeamMembers.jsp" class="style14">Back</a></div></td>
            </tr>
          </table>
