...
<title>Team Manager Solutions..</title>
		...
		<div id="content">
            ...
            <%
					  ...
					  int i=1,j=0,count=0,r=0;
						...
						try 
						{
						   	...
						   	String query="select * from defects_tmanager where prjname='"+prjname+"' and company='"+company+"' "; 
            ...
            <tr>
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                 ...
                 <a href="Admin_DeveloperProfile.jsp?type=<%="Admin_ViewTeamManagerSolution"%>&prjname=<%=prjname%>&uname=<%=s4%>" style="color:#CC0033">	<b> <%out.println(s4);%> </b> </a>
              </div></td>
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style8" >
                    <div align="center">
                 <a href="Admin_ManagerProfile.jsp?type=<%="Admin_ViewTeamManagerSolution"%>&prjname=<%=prjname%>&uname=<%=s0%>" style="color:#CC6600">    <b><%out.println(s0);%></b>       </a>         </div>
              </div></td>
			  ...
			  <td height="23"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style5" >
           	        <a href="Admin_ViewMngrSolution.jsp?prjname=<%=s1%>&id=<%=j%>" style="color:#FF3300"><b>View Solution</b></a> </div></td>	
			  </tr>
            <%
					i=i+1;	
