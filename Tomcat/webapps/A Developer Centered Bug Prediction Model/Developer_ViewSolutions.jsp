...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">View Solutions Based on Team Member and Team Manager..</a></h2>
				<div class="entry">
				<p>&nbsp;</p>
                    ...
                    <%
						...
						try 
						{
						   	String query="select distinct(prjname) from developer_project where company='"+company+"' and developer='"+developer+"' "; 
                    ...
                    <tr>
					  ...
					  <td height="0" align="center"  valign="middle"><a href="Developer_ViewTeamMbrSoln.jsp?prjname=<%=s1%>"><input name="adprj" type="button" value="View" /></a>					</td>
					  <td height="0" align="center"  valign="middle"><a href="Developer_ViewTeamMngrSoln.jsp?prjname=<%=s1%>"><input name="adprj" type="button" value="View" /></a>					</td>
                    </tr>
                    <%
						}
